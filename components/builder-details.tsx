      ...
      <div className="container mx-auto px-4 -mt-16 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end space-y-4 md:space-y-0 md:space-x-6 mb-8">
          ...
          <div className="flex-1">
            ...
            <h2 className="text-xl text-white/90 mb-2">{builder.tokenName}</h2>
            ...
            <div className="flex flex-wrap items-center gap-4 text-white/60">
              <div className="flex items-center space-x-1">
                <span>🏗️ Block #{builder.blockNumber.toLocaleString()}</span>
              </div>
              <div className="flex items-center space-x-1">
                <span>👥 {builder.holders.toLocaleString()} holders</span>
              </div>
            </div>
          </div>
